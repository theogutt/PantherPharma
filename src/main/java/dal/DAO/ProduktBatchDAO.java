...
public class ProduktBatchDAO implements IDAO<IProduktBatch> {
    ...
    @Override
    public void create(IProduktBatch produktBatch, Connection connection) throws SQLException {
    ...
    public IProduktBatch get(int produktBatchID, Connection connection) throws SQLException {
    ...
    public List<IProduktBatch> getList(Connection connection) throws SQLException {
    ...
    public void update(IProduktBatch produktBatch, Connection connection) throws SQLException {
    ...
    public void delete(int produktBatchID, Connection connection) throws SQLException {
        ...
        PreparedStatement statement1 = connection.prepareStatement(
                "DELETE FROM produktBatch WHERE produkt_råvare = ?");
        statement1.setInt(1, produktBatchID);
        statement1.executeUpdate();
